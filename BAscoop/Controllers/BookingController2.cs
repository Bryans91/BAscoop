...
{
    public class BookingController2 : Controller
    {
        private BioscoopDb db = new BioscoopDb();

        // GET: /BookingController2/
        public ActionResult Index()
        {
            return View(db.Bookings.ToList());
        }

        // GET: /BookingController2/Details/5
        ...
        // GET: /BookingController2/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: /BookingController2/Create
        ...
        // POST: /BookingController2/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: /BookingController2/Delete/5
        ...
        // POST: /BookingController2/Delete/5
